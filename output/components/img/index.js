...
class Img extends React.Component {
    ...
    render() {
        ...
        return React.createElement("img", { src: src, "data-src": _src, alt: "", style: { width: this.props.width ? this.props.width + "px" : "auto", height: this.props.height ? this.props.height + "px" : "auto" }, onClick: (e) => {
