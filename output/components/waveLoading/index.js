...
class WaveLoading extends React.Component {
    ...
    componentDidMount() {
        const canvas = this.refs.loading;
    ...
    render() {
        return React.createElement("div", { className: "wave_box", ref: "box", style: { background: this.props.bgColor } },
            React.createElement("canvas", { className: "wave_loading", ref: "loading" }, "\u5F53\u524D\u6D4F\u89C8\u5668\u4E0D\u652F\u6301canvas \u8BF7\u5347\u7EA7\uFF01"));
    }
}
