...
export const Alert = function (str: string) {
    ...
    //确定按钮和点击空白处消失
    const btn = document.querySelector(".alertModel .btn-submit") as HTMLInputElement;
    const overlay = document.querySelector(".alertModel .model-overlay") as HTMLInputElement;
...
export const Confirm = function (str: string, cb: Function) {
    ...
    alertDom.className = alertDom.className + " dialog-fadeIn";
    //确定按钮和点击空白处消失
    const btn_submit = document.querySelector(".confirmModel .btn-submit") as HTMLInputElement;
    const btn_cancel = document.querySelector(".confirmModel .btn-cancel") as HTMLInputElement;
    const overlay = document.querySelector(".confirmModel .model-overlay") as HTMLInputElement;
    const inReg = new RegExp("dialog-fadeIn", 'g');
    let result = false;
    overlay.onclick = () => {
        alertDom.className = alertDom.className.replace(inReg, "");
